                ...
                <div class="w-full lg:w-8/12">
                    ...
                    <div class="mt-6">
                        <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                            ...
                            <div class="mt-2"><a href="#" class="text-2xl font-bold text-gray-700 hover:underline overflow-x" >
                            {{$post->tittle}}
                                <p class="mt-2 text-gray-600">
                                    {{ Str::limit($post->content, 100) }}
                                </p>
                            </div>
                            <div class="flex items-center justify-between mt-4"><a href="{{ route('posts.show' , $post) " class="text-blue-500 hover:underline">Read more</a>
